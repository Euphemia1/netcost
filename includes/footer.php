            ...
            <div class="footer-grid">
                <div class="footer-col">
                    <div class="footer-logo">
                        <img src="<?php echo $base_path; ?>assets/images/logos/letter-head.jpg" alt="LT Construction" class="logo-image footer-logo-img" style="height: 60px; width: auto; filter: brightness(0) invert(1);">
                    </div>
