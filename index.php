    ...
    <div class="container">
        ...
        <div class="features-grid">
            <div class="feature-card" data-aos="fade-up">
                <div class="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <path d="M24 4L4 14L24 24L44 14L24 4Z" stroke="#001F3F" stroke-width="2" stroke-linejoin="round"/>
                        <path d="M4 34L24 44L44 34M4 24L24 34L44 24" stroke="#001F3F" stroke-width="2" stroke-linejoin="round"/>
                    </svg>
                </div>
            ...
            <div class="feature-card" data-aos="fade-up" data-aos-delay="100">
                <div class="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <circle cx="24" cy="24" r="20" stroke="#001F3F" stroke-width="2"/>
                        <path d="M24 12V24L32 28" stroke="#001F3F" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                </div>
            ...
            <div class="feature-card" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <rect x="8" y="12" width="32" height="28" rx="2" stroke="#001F3F" stroke-width="2"/>
                        <path d="M16 20H32M16 26H32M16 32H24" stroke="#001F3F" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                </div>
                <h3>Smart Reports</h3>
            ...
            <div class="feature-card" data-aos="fade-up" data-aos-delay="300">
                <div class="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <path d="M24 4V44M4 24H44" stroke="#001F3F" stroke-width="2" stroke-linecap="round"/>
                        <circle cx="24" cy="24" r="8" stroke="#001F3F" stroke-width="2"/>
                    </svg>
                </div>
            ...
            <div class="feature-card" data-aos="fade-up" data-aos-delay="400">
                <div class="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <path d="M12 24C12 17.373 17.373 12 24 12C30.627 12 36 17.373 36 24C36 30.627 30.627 36 24 36" stroke="#001F3F" stroke-width="2" stroke-linecap="round"/>
                        <path d="M24 36C17.373 36 12 30.627 12 24" stroke="#001F3F" stroke-width="2" stroke-linecap="round" stroke-dasharray="4 4"/>
                    </svg>
                </div>
            ...
            <div class="feature-card" data-aos="fade-up" data-aos-delay="500">
                <div class="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <path d="M24 4L30 16L44 18L34 28L36 44L24 37L12 44L14 28L4 18L18 16L24 4Z" stroke="#001F3F" stroke-width="2" stroke-linejoin="round"/>
                    </svg>
                </div>
                <h3>Award Winning</h3>
                ...
                <div class="demo-features">
                    <div class="demo-feature">
                        <div class="demo-feature-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="#001F3F" stroke-width="2" stroke-linejoin="round"/>
                                <path d="M2 17L12 22L22 17M2 12L12 17L22 12" stroke="#001F3F" stroke-width="2" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div>
